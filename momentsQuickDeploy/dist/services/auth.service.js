...
import { ACCESS_TOKEN_TTL_SECONDS, AUTH_TOKEN_SCOPE, REFRESH_TOKEN_TTL_SECONDS, tokenService } from './token.service.js';
...
export class AuthService {
    tokens;
    sessions;
    constructor(tokens = tokenService, sessions = sessionService) {
        this.tokens = tokens;
...
export async function ensureLoginAllowedUser(userId) {
